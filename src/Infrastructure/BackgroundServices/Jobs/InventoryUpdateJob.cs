...
public sealed class InventoryUpdateJob(IUnitOfWork unitOfWork, ILogger<InventoryUpdateJob> logger)
{
    ...
    {
        logger.LogInformation("Starting inventory update job");
        ...
        {
            logger.LogError(ex, "Error occurred during inventory update");
            throw;
        }
    }

...
public sealed class PropertyMapping : IRegister
{
    ...
    {
        // List
        config.NewConfig<Property, OptionTypeResult.ListItem>()
        ...
        // Details
        config.NewConfig<Property, OptionTypeResult.Details>()
            .Map(dest => dest.Id, src => src.Id)
            .Map(dest => dest.Name, src => src.Name)
            .Map(dest => dest.Presentation, src => src.Presentation)
        ...
        // Combo
        config.NewConfig<Property, OptionTypeResult.ComboItem>()
            .Map(dest => dest.Id, src => src.Id)
            .Map(dest => dest.Name, src => src.Name)
            .Map(dest => dest.Presentation, src => src.Presentation);
    }

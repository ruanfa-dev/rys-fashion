...
using UseCases.Admin.Catalogs.Properties.GetOptionList;
using UseCases.Catalogs.Properties.Create;
using UseCases.Catalogs.Properties.Delete;
using UseCases.Catalogs.Properties.GetById;
using UseCases.Catalogs.Properties.GetPagedList;
using UseCases.Catalogs.Properties.Update;
...
public sealed class PropertyManagementEndpoint : ICarterModule
{
    ...
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        .ProducesProblem(StatusCodes.Status500InternalServerError)
        .RequirePermission(Feature.Admin.Property.Read);
